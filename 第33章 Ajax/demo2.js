function createXHR() {
    if (typeof XMLHttpRequest != 'undefined') {
        return new XMLHttpRequest(); //创建xhr对象
...
//POST一般是web表单提交：比如<form method="post"><input type="text" name="name" value="Lee"><input type="text" name="age" value="100"></form>
//两种头信息：
...
//中文乱码问题，AJAX返回的数据其实是UTF-8的，最简单的解决方案就是全部设置UTF-8即可
